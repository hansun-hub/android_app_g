...
class SettingsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val sharedPreference = view.context.getSharedPreferences(
            "current",
        ...
        settings_btn1.setOnClickListener {
            ...
            // 폰트 설정
            val settings_tvDialogNickname =
                nicknameDialog?.findViewById<TextView>(android.R.id.message)
            settings_tvDialogNickname?.typeface =
        ...
        listview.onItemClickListener =
            AdapterView.OnItemClickListener { parent, view, position, id ->
                ...
                when (position) {
                    0 -> {
                        // 음량 조절 선택 시
                        val volume_fragment = SettingsVolumeFragment()
                    ...
                    2 -> {
                        ...
                        // 폰트 설정
                        val settings_tvDialogVersion =
                            versionDialog?.findViewById<TextView>(android.R.id.message)
                        settings_tvDialogVersion?.typeface =
                            Typeface.createFromAsset(view.context.assets, "jua_regular.ttf")
                    }
                    3 -> {
                        // Contact 선택 시
                    ...
                    4 -> {
                        ...
                        // 폰트 설정
                        val settings_tvDialogAboutUs =
                            aboutUsDialog?.findViewById<TextView>(android.R.id.message)
                        settings_tvDialogAboutUs?.typeface =
                            Typeface.createFromAsset(view.context.assets, "jua_regular.ttf")
                    }
                    5 -> {
                        // Log out 선택 시
                        ...
                        // 폰트 설정
                        val settings_tvDialogLogout =
                            logoutDialog?.findViewById<TextView>(android.R.id.message)
                        settings_tvDialogLogout?.typeface =
                            Typeface.createFromAsset(view.context.assets, "jua_regular.ttf")
                    }
                }
            }
