...
class SettingsDelAccFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val delacc_tv2 =
            view.findViewById<TextView>(R.id.delacc_tv2)                   // "회원탈퇴 진행을 위해 비밀번호를 입력해주세요."
        val delacc_tv3 =
            view.findViewById<TextView>(R.id.delacc_tv3)                   // 비밀번호 인증 실패 시 안내
        val delacc_tv4 =
            view.findViewById<TextView>(R.id.delacc_tv4)                   // 회원탈퇴 성공 시 안내
        ...
        val dbManager =
            DBManager(requireContext())                                     // DB Manager

        // 닉네임 불러오기 (**님!)
        delacc_tvTitle.text = getString(R.string.call_nickname, nickname) + "!"
        ...
        delacc_btn3.setOnClickListener {
            ...
            val userinput = delacc_edtPassword.text
